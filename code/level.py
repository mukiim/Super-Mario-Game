...
class Level:
	...
	def check_win(self):
		...
		for enemy in self.enemy_sprites.sprites():
			cnt = False
		if pygame.sprite.spritecollide(self.player.sprite,self.goal,False) and cnt == True:
	...
	def check_player_near(self):
		# Get player position
		player = self.player.sprite
		player_x = player.rect.x

	    # Iterate over enemy sprites
		for enemy in self.enemy_sprites.sprites():
			...
			if distance < 500 and not pygame.sprite.spritecollide(enemy,self.constraint_sprites,False):
