...
class Sky:
	def __init__(self,horizon,style = 'level'):
		self.top = pygame.image.load('../graphics/decoration/sky/sky_top.jpg').convert()
		self.bottom = pygame.image.load('../graphics/decoration/sky/sky_middle.jpg').convert()
		self.middle = pygame.image.load('../graphics/decoration/sky/sky_middle.jpg').convert()
